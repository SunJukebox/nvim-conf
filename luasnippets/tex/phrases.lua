...
autosnips = {
  ...
  s(
    ...
    { f(function(_, snip) return "\\(\\mathbb{" .. string.upper(snip.captures[1]) .. "}\\)-Cartier" end, {}) },
    { condition = tex.in_text }
  ),
  s(
    { trig = "([qr])d", name = "divisor", regTrig = true },
    { f(function(_, snip) return "\\(\\mathbb{" .. string.upper(snip.captures[1]) .. "}\\)-divisor" end, {}) },
    { condition = tex.in_text }
  ),
  ...
  s(
    ...
    { f(function(_, snip) return snip.captures[1] .. "ithout loss of generality" end, {}) },
    { condition = pipe { conds.line_begin, tex.in_text } }
  ),
