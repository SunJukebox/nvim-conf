...
snips = {
  ...
  s(
    ...
    { f(function(_, snip) return "\\mathfrak{" .. snip.captures[1] .. "}" end, {}) },
    { condition = tex.in_mathzone, show_condition = tex.in_mathzone }
  ),
  s(
    { trig = "s(%u)", name = "mathscr", wordTrig = false, regTrig = true, hidden = true },
    { f(function(_, snip) return "\\mathscr{" .. snip.captures[1] .. "}" end, {}) },
    { condition = tex.in_mathzone, show_condition = tex.in_mathzone }
  ),
...
autosnips = {
  ...
  s(
    ...
    { f(function(_, snip) return string.format("\\%si_{i}", snip.captures[1]) end, {}) },
  ...
  s(
    ...
    { f(function(_, snip) return string.format("\\%shi_{i}", snip.captures[1]) end, {}) },
    { condition = tex.in_mathzone }
  ),
  s(
  ...
  s(
    ...
    { f(function(_, snip) return string.format("\\%ssi_{i}", snip.captures[1]) end, {}) },
    { condition = tex.in_mathzone }
  ),

  s({ trig = "O([A-NP-Za-z])", name = "local ring, structure sheaf", wordTrig = false, regTrig = true }, {
    f(function(_, snip) return "\\mathcal{O}_{" .. snip.captures[1] .. "}" end, {}),
  }, { condition = tex.in_mathzone }),
  ...
  s(
    { trig = "GG", wordTrig = false, name = "algebraic group 𝔾" },
    { t "\\mathbb{G}" },
    { condition = tex.in_mathzone }
  ),
  ...
  s(
    ...
    { f(function(_, snip) return "\\mathbb{" .. snip.captures[1] .. "}^{>0}" end, {}) },
    { condition = tex.in_mathzone }
  ),
  s(
  ...
  s(
    ...
    { f(function(_, snip) return "\\sim_{\\mathbb{" .. string.upper(snip.captures[1]) .. "}} " end, {}) },
    { condition = tex.in_mathzone }
  ),
  ...
  s(
    ...
    { f(function(_, snip) return snip.captures[1] .. "_{j}" end, {}) },
    { condition = tex.in_mathzone }
  ),
